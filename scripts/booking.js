...
let daysButton = document.querySelectorAll('.day-selector li');
daysButton.forEach(function(i) {
...
function changeCost(element) {
    finalCost = costPerDay * numberOfDays;
    element.innerHTML = finalCost;
}
